...
public static class LevelData
{
    ...
    private static IDictionary<int, IDictionary<string,IDictionary<string,int>>> dict;
    ...
    {
        if(!(dict.ContainsKey(level) && dict[level].ContainsKey(objectCategory) && dict[level][objectCategory].ContainsKey(objectName)))
